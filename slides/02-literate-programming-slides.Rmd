---
title: "A Hands-on Introduction to Literate Programming with R"
author: "UCLA Social Science Data Archive"
output:
...
* Tim Dennis, UCLA Data Archive

## Attributions
* Slide deck created by Jenny Bryan
* Lessons based on the work of multiple Data Carpentry contributors. See AUTHORS file for a complete list.
...
* Adding citations to an R Markdown manuscript
